...
#SBATCH --output=./slurm18.out
#SBATCH --error=./slurm18.err
...
singularity exec --nv -B /hpc/group/carlsonlab/zdc6/ ~/wildfires/wildfire-tweets.sif python3 s_pfa.py \
	...
	--data_path /hpc/group/carlsonlab/zdc6/sPFA/data/1500_10_by_file/ \
	--tweet_agg_num 1500 \
	...
	--mse_weight 100 \
	--epochs 400 \
	--results_path /hpc/group/carlsonlab/zdc6/sPFA/results/exp19/
